...
Solution_3::Solution_3() = default;



std::string Solution_3::float_to_string(float value, int decimal_places) {

    char result[20] = {' '};
    dtostrf((double) value, 0, decimal_places, result);
    std::string result_str(result);
    return result_str;
}

char* Solution_3::dtostrf(double val, signed char width, unsigned char prec, char *sout)
{
