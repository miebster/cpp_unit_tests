...
TEST_CASE("test_case_1"){
    ...
    CHECK(solution2.threeSum(q1) == a1);
}
...
TEST_CASE("test_case_3"){
    ...
    // todo compareVector squashes triplets when same value is used (because its a set, should be something else)
    CHECK(compareVectorVectorInts(solution2.threeSum(q1),a1));
}
...
TEST_CASE("test_case_4") {
    ...
    Solution_2 solution2;
    vector<vector<int>> result = solution2.threeSum(question);
